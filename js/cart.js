...
// Находим блок с товаром, внутри которого был совершен клик
const card = event.target.closest('.card');

if (parseInt(card.querySelector('[data-counter]').innerText) > 0) {
...
const cartItemHTML = `<div class="cart-item" data-id="${productInfo.id}">
							...
							<div class="cart-item__img">
							 <img src="${productInfo.imgSrc}" height="90" alt="">
									</div>
